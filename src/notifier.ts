...
export class Notifier {
  ...
  async notify(results: RunResult[]): Promise<void> {
  ...
  private async sendSlack(results: RunResult[], allPassed: boolean): Promise<void> {
  ...
  private async sendWebhook(results: RunResult[], allPassed: boolean): Promise<void> {
