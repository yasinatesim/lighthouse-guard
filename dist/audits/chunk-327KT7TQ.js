...
var require_frame = __commonJS({
  "node_modules/speedline-core/lib/frame.js"(exports, module) {
    ...
    __name(isWhitePixel, "isWhitePixel");
    function convertPixelsToHistogram(img) {
      const createHistogramArray = /* @__PURE__ */ __name(function() {
        const ret = [];
        for (let i = 0; i < 256; i++) {
          ret[i] = 0;
        }
    ...
    __name(convertPixelsToHistogram, "convertPixelsToHistogram");
    ...
    __name(synthesizeWhiteFrame, "synthesizeWhiteFrame");
    ...
    __name(extractFramesFromTimeline, "extractFramesFromTimeline");
    function frame(imgBuff, ts) {
      ...
      return {
        getHistogram: /* @__PURE__ */ __name(function() {
          if (_histogram) {
            return _histogram;
          }
        ...
        getTimeStamp: /* @__PURE__ */ __name(function() {
          return ts;
        }, "getTimeStamp"),
        setProgress: /* @__PURE__ */ __name(function(progress, isInterpolated) {
          _progress = progress;
          _isProgressInterpolated = Boolean(isInterpolated);
        }, "setProgress"),
        setPerceptualProgress: /* @__PURE__ */ __name(function(progress, isInterpolated) {
          _perceptualProgress = progress;
          _isPerceptualProgressInterpolated = Boolean(isInterpolated);
        }, "setPerceptualProgress"),
        getImage: /* @__PURE__ */ __name(function() {
          return imgBuff;
        }, "getImage"),
        getParsedImage: /* @__PURE__ */ __name(function() {
          if (!_parsedImage) {
        ...
        isProgressInterpolated: /* @__PURE__ */ __name(function() {
          return _isProgressInterpolated;
        }, "isProgressInterpolated"),
        getPerceptualProgress: /* @__PURE__ */ __name(function() {
          return _perceptualProgress;
        }, "getPerceptualProgress"),
        isPerceptualProgressInterpolated: /* @__PURE__ */ __name(function() {
  ...
  "node_modules/image-ssim/index.js"(exports, module) {
    ...
    (function(ImageSSIM2) {
      ...
      (function(Internals2) {
        ...
        __name(_lumaValuesForWindow, "_lumaValuesForWindow");
        ...
        __name(_averageLuma, "_averageLuma");
      })(Internals || (Internals = {}));
    })(ImageSSIM || (ImageSSIM = {}));
...
var require_speed_index = __commonJS({
  "node_modules/speedline-core/lib/speed-index.js"(exports, module) {
    ...
    __name(calculateFastModeAllowableChange, "calculateFastModeAllowableChange");
    ...
    __name(calculateFrameProgress, "calculateFrameProgress");
    ...
    __name(calculateProgressBetweenFrames, "calculateProgressBetweenFrames");
    ...
    __name(calculateVisualProgress, "calculateVisualProgress");
    ...
    __name(calculateFrameSimilarity, "calculateFrameSimilarity");
    ...
    __name(calculatePerceptualProgress, "calculatePerceptualProgress");
    ...
    __name(calculateSpeedIndexes, "calculateSpeedIndexes");
    module.exports = {
...
var require_lib = __commonJS({
  "node_modules/speedline-core/lib/index.js"(exports, module) {
    ...
    __name(calculateValues, "calculateValues");
    var Include = {
      All: "all",
