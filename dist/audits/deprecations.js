...
// node_modules/lighthouse/core/lib/deprecation-description.js
var UIStrings3 = {
...
var deprecationsStr_ = createIcuMessageFn(
...
function getIssueDetailDescription(issueDetails) {
  ...
  const maybeEnglishMessage = UIStrings2[type];
  ...
  if (feature !== 0) {
    links.push({
      ...
      linkTitle: str_(UIStrings3.feature)
    });
  }
  ...
  if (milestone !== 0) {
    links.push({
      ...
      linkTitle: str_(UIStrings3.milestone, { milestone })
    });
  }
  return {
    substitutions: /* @__PURE__ */ new Map([
      ["PLACEHOLDER_title", str_(UIStrings3.title)],
...
var Deprecations = class extends Audit {
  ...
  static get meta() {
    return {
      id: "deprecations",
      title: str_2(UIStrings4.title),
      failureTitle: str_2(UIStrings4.failureTitle),
      description: str_2(UIStrings4.description),
  ...
  static async audit(artifacts, context) {
    ...
    const headings = [
      { key: "value", valueType: "text", label: str_2(UIStrings4.columnDeprecate) },
      { key: "source", valueType: "source-location", label: str_2(UIStrings.columnSource) }
    ];
    const details = Audit.makeTableDetails(headings, deprecations);
    let displayValue;
    if (deprecations.length > 0) {
      displayValue = str_2(UIStrings4.displayValue, { itemCount: deprecations.length });
    }
    return {
...
var deprecations_default = Deprecations;
export {
  UIStrings4 as UIStrings,
  deprecations_default as default
};
/*! Bundled license information:

lighthouse/core/lib/deprecation-description.js:
  (**
   * @license
