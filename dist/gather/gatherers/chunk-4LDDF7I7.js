...
__name(provideThirdPartyWeb, "provideThirdPartyWeb");
...
var EntityClassification = class _EntityClassification {
  ...
  static async compute_(data, context) {
    ...
    __name(isFirstParty2, "isFirstParty");
    return {
      entityByUrl,
      urlsByEntity,
      firstParty,
...
async function init(opts) {
  ...
  try {
    const Sentry2 = await import("./esm-OKM7RA5Z.js");
    Sentry2.init({
